...
import './BookLunch.css'
import { FaPlus } from 'react-icons/fa';

const offerBoxArray = ["Fixed bundle","Bundle plus free product", "Complimentary product with threshold", "Fixed discount with threshold","Set menu"];
        ...
        <div className='appReviewRegistration'>
            ...
            {showForm && (
                <>
                    ...
                    {(offerTypeChoice === offerBoxArray[2]) && <Form3 />}
                    {(offerTypeChoice === offerBoxArray[3]) && <Form4 />}
                    {(offerTypeChoice === offerBoxArray[4]) && <Form5 />}
                </>
            )}
            ...
            <div className="innerForm">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-4">
                            <div className="firstProductBox active " >
                            ...
                            <h5 className='badge badge-primary'>Free Products</h5>
...
const Form4 = () => {
    ...
    const createDiscount = () => {
        ...
        newObjct.days = days;
        newObjct.threshold = threshold;
        newObjct.fixedPrice = fixedPrice;
        newObjct.draft = draft;
        console.log("newObjct :", newObjct)
        setLoading(true);
        const myHeaders = new Headers();
